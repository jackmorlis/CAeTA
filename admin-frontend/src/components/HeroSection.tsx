        ...
        <div className="relative bg-white/85 backdrop-blur-md w-3/5 md:w-3/5 lg:w-3/5 flex items-start pt-2 md:pt-3 lg:pt-2 pb-2 md:pb-3 lg:pb-6">
          <div className="p-4 md:p-6 lg:p-12 w-full">
            <div className="space-y-3 md:space-y-4 lg:space-y-6 text-left">
              {/* Headline */}
              <div>
                <h1 className="text-2xl md:text-3xl lg:text-6xl font-bold text-primary mb-2 md:mb-3 lg:mb-4 leading-tight">Curaçao Digital Immigration Card</h1>
                <p className="text-sm md:text-base lg:text-2xl text-gray-800 mb-3 md:mb-4 lg:mb-6 leading-relaxed font-medium">Travelers must present a valid Curaçao Digital Immigration Card to complete entry formalities upon arrival.</p>
              </div>
              ...
              <div className="space-y-3 md:space-y-4 lg:grid lg:grid-cols-2 lg:gap-6 lg:space-y-0">
                ...
                <div className="flex items-start gap-2 md:gap-3 lg:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-xs md:text-xs lg:text-base font-medium">Your Curaçao Digital Immigration Card will be sent to your email as a PDF document.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col lg:flex-row gap-2 md:gap-3 lg:gap-4 pt-2 lg:pt-3">
                <Button size="lg" onClick={() => navigate('/apply')} className="w-full bg-primary hover:bg-primary-dark text-primary-foreground font-bold px-3 md:px-4 lg:px-8 py-2 md:py-3 lg:py-4 shadow-lg hover:shadow-xl transition-all duration-300 text-xs md:text-sm lg:text-base">Apply for Your Curaçao Digital Immigration Card</Button>
            ...
            <div className="space-y-4 text-left">
              ...
              <div className="flex flex-col gap-3 pt-2">
                <Button size="lg" onClick={() => navigate('/apply')} className="w-full bg-primary hover:bg-primary-dark text-primary-foreground font-bold px-4 py-3 shadow-lg hover:shadow-xl transition-all duration-300 text-sm">
                  Apply for Your Curaçao Digital Immigration Card
                </Button>
