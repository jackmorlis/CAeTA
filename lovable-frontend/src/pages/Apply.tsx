...
const Apply = () => {
  ...
  // ─── Auto-select phone country code based on nationality ────────────
  const passportToPhone: Record<string, string> = useMemo(() => ({
    AFG: '+93', AGO: '+244', ALB: '+355', AND: '+376', ANG: '+1-264',
    ARE: '+971', ARG: '+54', ARM: '+374', ATG: '+1-268', AUS: '+61',
    AUT: '+43', AZE: '+994', BDI: '+257', BEL: '+32', BEN: '+229',
    BFA: '+226', BGD: '+880', BGR: '+359', BHR: '+973', BHS: '+1-242',
    BIH: '+387', BLR: '+375', BLZ: '+501', BMU: '+1-441', BOL: '+591',
    BRA: '+55', BRB: '+1-246', BRN: '+673', BTN: '+975', BWA: '+267',
    CAF: '+236', CAN: '+1', CHE: '+41', CHL: '+56', CHN: '+86',
    'CHN-HK': '+852', 'CHN-MO': '+853', CIV: '+225', CMR: '+237',
    COD: '+243', COG: '+242', COL: '+57', COM: '+269', CPV: '+238',
    CRI: '+506', CUB: '+53', CYM: '+1-345', CYP: '+357', CZE: '+420',
    D: '+49', DJI: '+253', DMA: '+1-767', DNK: '+45', DOM: '+1-809',
    DZA: '+213', ECU: '+593', EGY: '+20', ERI: '+291', ESP: '+34',
    EST: '+372', ETH: '+251', FIN: '+358', FJI: '+679', FRA: '+33',
    FSM: '+691', GAB: '+241', GBD: '+44', GBN: '+44', GBO: '+44',
    GBP: '+44', GBR: '+44', GBS: '+44', GEO: '+995', GHA: '+233',
    GIN: '+224', GMB: '+220', GNB: '+245', GNQ: '+240', GRC: '+30',
    GRD: '+1-473', GTM: '+502', GUY: '+592', HND: '+504', HRV: '+385',
    HTI: '+509', HUN: '+36', IDN: '+62', IND: '+91', IRL: '+353',
    IRN: '+98', IRQ: '+964', ISL: '+354', ISR: '+972', ITA: '+39',
    JAM: '+1-876', JOR: '+962', JPN: '+81', KAZ: '+7', KEN: '+254',
    KGZ: '+996', KHM: '+855', KIR: '+686', KNA: '+1-869', KOR: '+82',
    KWT: '+965', LAO: '+856', LBN: '+961', LBR: '+231', LBY: '+218',
    LCA: '+1-758', LIE: '+423', LKA: '+94', LSO: '+266', LTU: '+370',
    LUX: '+352', LVA: '+371', MAR: '+212', MCO: '+377', MDA: '+373',
    MDG: '+261', MDV: '+960', MEX: '+52', MHL: '+692', MKD: '+389',
    MLI: '+223', MLT: '+356', MMR: '+95', MNE: '+382', MNG: '+976',
    MOZ: '+258', MRT: '+222', MSR: '+1-664', MUS: '+230', MWI: '+265',
    MYS: '+60', NAM: '+264', NER: '+227', NGA: '+234', NIC: '+505',
    NLD: '+31', NOR: '+47', NPL: '+977', NRU: '+674', NZL: '+64',
    OMN: '+968', PAK: '+92', PAN: '+507', PER: '+51', PHL: '+63',
    PLW: '+680', PNG: '+675', POL: '+48', PRK: '+850', PRT: '+351',
    PRY: '+595', PSE: '+970', QAT: '+974', RKS: '+383', ROU: '+40',
    RUS: '+7-7', RWA: '+250', SAU: '+966', SDN: '+249', SEN: '+221',
    SGP: '+65', SLB: '+677', SLE: '+232', SLV: '+503', SMR: '+378',
    SOM: '+252', SRB: '+381', SSD: '+211', STP: '+239', SUR: '+597',
    SVK: '+421', SVN: '+386', SWE: '+46', SWZ: '+268', SYC: '+248',
    SYR: '+963', TCA: '+1-649', TCD: '+235', TGO: '+228', THA: '+66',
    TJK: '+992', TKM: '+993', TLS: '+670', TON: '+676', TTO: '+1-868',
    TUN: '+216', TUR: '+90', TUV: '+688', TWN: '+886', TZA: '+255',
    UGA: '+256', UKR: '+380', URY: '+598', USA: '+1', UZB: '+998',
    VCT: '+1-784', VEN: '+58', VGB: '+1-284', VNM: '+84', VUT: '+678',
    WSM: '+685', YEM: '+967', ZAF: '+27', ZMB: '+260', ZWE: '+263',
  }), []);

  useEffect(() => {
    if (!watchCountryCode) return;
    const dialCode = passportToPhone[watchCountryCode];
    if (dialCode) {
      form.setValue('phoneCountryCode', dialCode);
    }
  }, [watchCountryCode]);
  ...
  const phoneCountryCodes = [
    { value: '+93', flag: '🇦🇫', name: 'Afghanistan' },
    { value: '+355', flag: '🇦🇱', name: 'Albania' },
    { value: '+213', flag: '🇩🇿', name: 'Algeria' },
    { value: '+376', flag: '🇦🇩', name: 'Andorra' },
    { value: '+244', flag: '🇦🇴', name: 'Angola' },
    { value: '+1-268', flag: '🇦🇬', name: 'Antigua and Barbuda' },
    { value: '+54', flag: '🇦🇷', name: 'Argentina' },
    { value: '+374', flag: '🇦🇲', name: 'Armenia' },
    { value: '+61', flag: '🇦🇺', name: 'Australia' },
    { value: '+43', flag: '🇦🇹', name: 'Austria' },
    { value: '+994', flag: '🇦🇿', name: 'Azerbaijan' },
    { value: '+1-242', flag: '🇧🇸', name: 'Bahamas' },
    { value: '+973', flag: '🇧🇭', name: 'Bahrain' },
    { value: '+880', flag: '🇧🇩', name: 'Bangladesh' },
    { value: '+1-246', flag: '🇧🇧', name: 'Barbados' },
    { value: '+375', flag: '🇧🇾', name: 'Belarus' },
    { value: '+32', flag: '🇧🇪', name: 'Belgium' },
    { value: '+501', flag: '🇧🇿', name: 'Belize' },
    { value: '+229', flag: '🇧🇯', name: 'Benin' },
    { value: '+975', flag: '🇧🇹', name: 'Bhutan' },
    { value: '+591', flag: '🇧🇴', name: 'Bolivia' },
    { value: '+387', flag: '🇧🇦', name: 'Bosnia and Herzegovina' },
    { value: '+267', flag: '🇧🇼', name: 'Botswana' },
    { value: '+55', flag: '🇧🇷', name: 'Brazil' },
    { value: '+673', flag: '🇧🇳', name: 'Brunei' },
    { value: '+359', flag: '🇧🇬', name: 'Bulgaria' },
    { value: '+226', flag: '🇧🇫', name: 'Burkina Faso' },
    { value: '+257', flag: '🇧🇮', name: 'Burundi' },
    { value: '+855', flag: '🇰🇭', name: 'Cambodia' },
    { value: '+237', flag: '🇨🇲', name: 'Cameroon' },
    { value: '+1', flag: '🇨🇦', name: 'Canada / USA' },
    { value: '+238', flag: '🇨🇻', name: 'Cape Verde' },
    { value: '+236', flag: '🇨🇫', name: 'Central African Republic' },
    { value: '+235', flag: '🇹🇩', name: 'Chad' },
    { value: '+56', flag: '🇨🇱', name: 'Chile' },
    { value: '+86', flag: '🇨🇳', name: 'China' },
    { value: '+57', flag: '🇨🇴', name: 'Colombia' },
    { value: '+269', flag: '🇰🇲', name: 'Comoros' },
    { value: '+242', flag: '🇨🇬', name: 'Congo' },
    { value: '+243', flag: '🇨🇩', name: 'Congo, DR' },
    { value: '+506', flag: '🇨🇷', name: 'Costa Rica' },
    { value: '+385', flag: '🇭🇷', name: 'Croatia' },
    { value: '+53', flag: '🇨🇺', name: 'Cuba' },
    { value: '+357', flag: '🇨🇾', name: 'Cyprus' },
    { value: '+420', flag: '🇨🇿', name: 'Czech Republic' },
    { value: '+45', flag: '🇩🇰', name: 'Denmark' },
    { value: '+253', flag: '🇩🇯', name: 'Djibouti' },
    { value: '+1-767', flag: '🇩🇲', name: 'Dominica' },
    { value: '+1-809', flag: '🇩🇴', name: 'Dominican Republic' },
    { value: '+593', flag: '🇪🇨', name: 'Ecuador' },
    { value: '+20', flag: '🇪🇬', name: 'Egypt' },
    { value: '+503', flag: '🇸🇻', name: 'El Salvador' },
    { value: '+240', flag: '🇬🇶', name: 'Equatorial Guinea' },
    { value: '+291', flag: '🇪🇷', name: 'Eritrea' },
    { value: '+372', flag: '🇪🇪', name: 'Estonia' },
    { value: '+251', flag: '🇪🇹', name: 'Ethiopia' },
    { value: '+679', flag: '🇫🇯', name: 'Fiji' },
    { value: '+358', flag: '🇫🇮', name: 'Finland' },
    { value: '+33', flag: '🇫🇷', name: 'France' },
    { value: '+241', flag: '🇬🇦', name: 'Gabon' },
    { value: '+220', flag: '🇬🇲', name: 'Gambia' },
    { value: '+995', flag: '🇬🇪', name: 'Georgia' },
    { value: '+49', flag: '🇩🇪', name: 'Germany' },
    { value: '+233', flag: '🇬🇭', name: 'Ghana' },
    { value: '+30', flag: '🇬🇷', name: 'Greece' },
    { value: '+1-473', flag: '🇬🇩', name: 'Grenada' },
    { value: '+502', flag: '🇬🇹', name: 'Guatemala' },
    { value: '+224', flag: '🇬🇳', name: 'Guinea' },
    { value: '+245', flag: '🇬🇼', name: 'Guinea-Bissau' },
    { value: '+592', flag: '🇬🇾', name: 'Guyana' },
    { value: '+509', flag: '🇭🇹', name: 'Haiti' },
    { value: '+504', flag: '🇭🇳', name: 'Honduras' },
    { value: '+852', flag: '🇭🇰', name: 'Hong Kong' },
    { value: '+36', flag: '🇭🇺', name: 'Hungary' },
    { value: '+354', flag: '🇮🇸', name: 'Iceland' },
    { value: '+91', flag: '🇮🇳', name: 'India' },
    { value: '+62', flag: '🇮🇩', name: 'Indonesia' },
    { value: '+98', flag: '🇮🇷', name: 'Iran' },
    { value: '+964', flag: '🇮🇶', name: 'Iraq' },
    { value: '+353', flag: '🇮🇪', name: 'Ireland' },
    { value: '+972', flag: '🇮🇱', name: 'Israel' },
    { value: '+39', flag: '🇮🇹', name: 'Italy' },
    { value: '+225', flag: '🇨🇮', name: 'Ivory Coast' },
    { value: '+1-876', flag: '🇯🇲', name: 'Jamaica' },
    { value: '+81', flag: '🇯🇵', name: 'Japan' },
    { value: '+962', flag: '🇯🇴', name: 'Jordan' },
    { value: '+7', flag: '🇰🇿', name: 'Kazakhstan' },
    { value: '+254', flag: '🇰🇪', name: 'Kenya' },
    { value: '+686', flag: '🇰🇮', name: 'Kiribati' },
    { value: '+965', flag: '🇰🇼', name: 'Kuwait' },
    { value: '+996', flag: '🇰🇬', name: 'Kyrgyzstan' },
    { value: '+856', flag: '🇱🇦', name: 'Laos' },
    { value: '+371', flag: '🇱🇻', name: 'Latvia' },
    { value: '+961', flag: '🇱🇧', name: 'Lebanon' },
    { value: '+266', flag: '🇱🇸', name: 'Lesotho' },
    { value: '+231', flag: '🇱🇷', name: 'Liberia' },
    { value: '+218', flag: '🇱🇾', name: 'Libya' },
    { value: '+423', flag: '🇱🇮', name: 'Liechtenstein' },
    { value: '+370', flag: '🇱🇹', name: 'Lithuania' },
    { value: '+352', flag: '🇱🇺', name: 'Luxembourg' },
    { value: '+853', flag: '🇲🇴', name: 'Macau' },
    { value: '+261', flag: '🇲🇬', name: 'Madagascar' },
    { value: '+265', flag: '🇲🇼', name: 'Malawi' },
    { value: '+60', flag: '🇲🇾', name: 'Malaysia' },
    { value: '+960', flag: '🇲🇻', name: 'Maldives' },
    { value: '+223', flag: '🇲🇱', name: 'Mali' },
    { value: '+356', flag: '🇲🇹', name: 'Malta' },
    { value: '+692', flag: '🇲🇭', name: 'Marshall Islands' },
    { value: '+222', flag: '🇲🇷', name: 'Mauritania' },
    { value: '+230', flag: '🇲🇺', name: 'Mauritius' },
    { value: '+52', flag: '🇲🇽', name: 'Mexico' },
    { value: '+691', flag: '🇫🇲', name: 'Micronesia' },
    { value: '+373', flag: '🇲🇩', name: 'Moldova' },
    { value: '+377', flag: '🇲🇨', name: 'Monaco' },
    { value: '+976', flag: '🇲🇳', name: 'Mongolia' },
    { value: '+382', flag: '🇲🇪', name: 'Montenegro' },
    { value: '+212', flag: '🇲🇦', name: 'Morocco' },
    { value: '+258', flag: '🇲🇿', name: 'Mozambique' },
    { value: '+95', flag: '🇲🇲', name: 'Myanmar' },
    { value: '+264', flag: '🇳🇦', name: 'Namibia' },
    { value: '+674', flag: '🇳🇷', name: 'Nauru' },
    { value: '+977', flag: '🇳🇵', name: 'Nepal' },
    { value: '+31', flag: '🇳🇱', name: 'Netherlands' },
    { value: '+64', flag: '🇳🇿', name: 'New Zealand' },
    { value: '+505', flag: '🇳🇮', name: 'Nicaragua' },
    { value: '+227', flag: '🇳🇪', name: 'Niger' },
    { value: '+234', flag: '🇳🇬', name: 'Nigeria' },
    { value: '+850', flag: '🇰🇵', name: 'North Korea' },
    { value: '+389', flag: '🇲🇰', name: 'North Macedonia' },
    { value: '+47', flag: '🇳🇴', name: 'Norway' },
    { value: '+968', flag: '🇴🇲', name: 'Oman' },
    { value: '+92', flag: '🇵🇰', name: 'Pakistan' },
    { value: '+680', flag: '🇵🇼', name: 'Palau' },
    { value: '+970', flag: '🇵🇸', name: 'Palestine' },
    { value: '+507', flag: '🇵🇦', name: 'Panama' },
    { value: '+675', flag: '🇵🇬', name: 'Papua New Guinea' },
    { value: '+595', flag: '🇵🇾', name: 'Paraguay' },
    { value: '+51', flag: '🇵🇪', name: 'Peru' },
    { value: '+63', flag: '🇵🇭', name: 'Philippines' },
    { value: '+48', flag: '🇵🇱', name: 'Poland' },
    { value: '+351', flag: '🇵🇹', name: 'Portugal' },
    { value: '+974', flag: '🇶🇦', name: 'Qatar' },
    { value: '+40', flag: '🇷🇴', name: 'Romania' },
    { value: '+7-7', flag: '🇷🇺', name: 'Russia' },
    { value: '+250', flag: '🇷🇼', name: 'Rwanda' },
    { value: '+1-869', flag: '🇰🇳', name: 'Saint Kitts and Nevis' },
    { value: '+1-758', flag: '🇱🇨', name: 'Saint Lucia' },
    { value: '+1-784', flag: '🇻🇨', name: 'Saint Vincent' },
    { value: '+685', flag: '🇼🇸', name: 'Samoa' },
    { value: '+378', flag: '🇸🇲', name: 'San Marino' },
    { value: '+239', flag: '🇸🇹', name: 'Sao Tome and Principe' },
    { value: '+966', flag: '🇸🇦', name: 'Saudi Arabia' },
    { value: '+221', flag: '🇸🇳', name: 'Senegal' },
    { value: '+381', flag: '🇷🇸', name: 'Serbia' },
    { value: '+248', flag: '🇸🇨', name: 'Seychelles' },
    { value: '+232', flag: '🇸🇱', name: 'Sierra Leone' },
    { value: '+65', flag: '🇸🇬', name: 'Singapore' },
    { value: '+421', flag: '🇸🇰', name: 'Slovakia' },
    { value: '+386', flag: '🇸🇮', name: 'Slovenia' },
    { value: '+677', flag: '🇸🇧', name: 'Solomon Islands' },
    { value: '+252', flag: '🇸🇴', name: 'Somalia' },
    { value: '+27', flag: '🇿🇦', name: 'South Africa' },
    { value: '+82', flag: '🇰🇷', name: 'South Korea' },
    { value: '+211', flag: '🇸🇸', name: 'South Sudan' },
    { value: '+34', flag: '🇪🇸', name: 'Spain' },
    { value: '+94', flag: '🇱🇰', name: 'Sri Lanka' },
    { value: '+249', flag: '🇸🇩', name: 'Sudan' },
    { value: '+597', flag: '🇸🇷', name: 'Suriname' },
    { value: '+46', flag: '🇸🇪', name: 'Sweden' },
    { value: '+41', flag: '🇨🇭', name: 'Switzerland' },
    { value: '+963', flag: '🇸🇾', name: 'Syria' },
    { value: '+886', flag: '🇹🇼', name: 'Taiwan' },
    { value: '+992', flag: '🇹🇯', name: 'Tajikistan' },
    { value: '+255', flag: '🇹🇿', name: 'Tanzania' },
    { value: '+66', flag: '🇹🇭', name: 'Thailand' },
    { value: '+670', flag: '🇹🇱', name: 'Timor-Leste' },
    { value: '+228', flag: '🇹🇬', name: 'Togo' },
    { value: '+676', flag: '🇹🇴', name: 'Tonga' },
    { value: '+1-868', flag: '🇹🇹', name: 'Trinidad and Tobago' },
    { value: '+216', flag: '🇹🇳', name: 'Tunisia' },
    { value: '+90', flag: '🇹🇷', name: 'Turkey' },
    { value: '+993', flag: '🇹🇲', name: 'Turkmenistan' },
    { value: '+688', flag: '🇹🇻', name: 'Tuvalu' },
    { value: '+256', flag: '🇺🇬', name: 'Uganda' },
    { value: '+380', flag: '🇺🇦', name: 'Ukraine' },
    { value: '+971', flag: '🇦🇪', name: 'United Arab Emirates' },
    { value: '+44', flag: '🇬🇧', name: 'United Kingdom' },
    { value: '+598', flag: '🇺🇾', name: 'Uruguay' },
    { value: '+998', flag: '🇺🇿', name: 'Uzbekistan' },
    { value: '+678', flag: '🇻🇺', name: 'Vanuatu' },
    { value: '+58', flag: '🇻🇪', name: 'Venezuela' },
    { value: '+84', flag: '🇻🇳', name: 'Vietnam' },
    { value: '+967', flag: '🇾🇪', name: 'Yemen' },
    { value: '+260', flag: '🇿🇲', name: 'Zambia' },
    { value: '+263', flag: '🇿🇼', name: 'Zimbabwe' },
  ];
                    ...
                    <div className="space-y-8">
                      ...
                      <FormField control={form.control} name="phoneNumber" render={({ field: phoneField }) => (
                        <FormItem className="space-y-3">
                          ...
                          <div className="grid grid-cols-[200px_1fr] sm:grid-cols-[240px_1fr] gap-3">
                                ...
                                <Select onValueChange={field.onChange} value={field.value}>
                                  <FormControl>
                                    <SelectTrigger className="h-12 border-2 border-gray-200 hover:border-primary focus:border-primary">
                                      <SelectValue placeholder="Select code">
                                        {field.value && (() => {
                                          const found = phoneCountryCodes.find(c => c.value === field.value);
                                          return found ? `${found.flag} ${found.name} (${found.value})` : field.value;
                                        })()}
                                      </SelectValue>
                                    </SelectTrigger>
                                  </FormControl>
                                  <SelectContent className="max-h-72">
                                    {phoneCountryCodes.map(c => (
                                      <SelectItem key={c.value} value={c.value}>{c.flag} {c.name} ({c.value})</SelectItem>
                                    ))}
                                  </SelectContent>
                                </Select>
                                <FormMessage />
